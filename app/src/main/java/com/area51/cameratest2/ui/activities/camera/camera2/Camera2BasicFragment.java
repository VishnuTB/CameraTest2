...
import com.area51.cameratest2.utils.widgets.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment implements
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            Timber.i("onImageAvailable");
            File myDir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + getString(R.string.app_name) + "/BixByImages");
            myDir.mkdirs();
            String fileName = Calendar.getInstance(Locale.getDefault()).getTimeInMillis() + ".jpg";
            File mFile = new File(myDir, fileName);
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture texture, int width, int height) {
            ...
            Bitmap.createBitmap(mTextureView.getWidth(), mTextureView.getHeight(), Bitmap.Config.ARGB_8888);
...
//        view.findViewById(R.id.info).setOnClickListener(this);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(ImageUtils.getImageLocation() + "/", "pic.jpg");
    }
